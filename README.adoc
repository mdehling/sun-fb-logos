...
image:krups-oslogo-0.png["JavaStation-NC Loading Animation Frame 1"]
image:krups-oslogo-1.png["JavaStation-NC Loading Animation Frame 2"]
image:krups-oslogo-2.png["JavaStation-NC Loading Animation Frame 3"]
image:krups-oslogo-3.png["JavaStation-NC Loading Animation Frame 4"]
...
Among them are: Neill Griffin, Mark Mehalik, Gábor Samu, Chris Satterfield,
Mike Spooner, and Irinikus from irixnet.org.  Thanks a lot, everyone!
