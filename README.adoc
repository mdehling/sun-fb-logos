...
Among them are: Neill Griffin, Imre Kaloz, Mark Mehalik, Darko Mesaroš, Alan
Perry, Gábor Samu, Chris Satterfield, Mike Spooner, Valery Ushakov, and
Irinikus from irixnet.org.
